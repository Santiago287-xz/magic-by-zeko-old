...
export default function Footer() {
  ...
  const lightLogoURL =
    "https://media.discordapp.net/attachments/1116888339967119460/1156796158556000306/MBZ-Negro.png?ex=651991a0&is=65184020&hm=dcc99635d3938a3048b1641fa9da89b2ba169e3c6d3c5f35f58f1b22e9dbd04a&=&width=1020&height=379";
  const darkLogoURL =
    "https://media.discordapp.net/attachments/1116888339967119460/1156796158295949322/MBZ-Blanco.png?ex=651991a0&is=65184020&hm=4fc8bb10c7cf1f23bd482d9c1fe6f935e97ebd813aee613507969f471fa23bc7&=&width=1020&height=379";
      ...
      <footer className="w-full flex items-center justify-center flex-col pb-3 pt-6 gap-5 bg-gray-800">
        <main className="w-4/5 md:w-1/3 lg:w-1/2">
          <section className="flex justify-evenly gap-48">
            ...
            <ol className="mx-4 mt-2 flex-col gap-2 hidden sm:flex">
        ...
        <img src={logoURL} alt="Logo" width={225} height={255} />
